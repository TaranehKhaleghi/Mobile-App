...
function TKSaveDefaultEmail(){
        var DefaultEmail = $("#TKDefaultReE").val();

        TKInitStorage();
        TKAddtoStorage();

        function TKInitStorage(){
                localStorage.setItem("DefaultEmail", DefaultEmail);
        }
        function TKAddtoStorage(){
                if (localStorage.getItem("DefaultEmail")){
                        window.alert("Default student email saved:"+ localStorage.getItem("DefaultEmail"));
                }
                else{
                        window.alert("Default student email save failed")
                }
        }
}
...
function TKAddFeedback(){
        if(TKDoValidate_frmAdd())
        {
